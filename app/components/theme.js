...
const ANALYSIS_COLORFUL = (isDarkMode) => ({
  ...
  violet: {
    ...
    textLight:      isDarkMode ? 'text-violet-400' : 'text-violet-600',
    textLighter:    'text-violet-500',
    bg:             isDarkMode ? 'bg-violet-900' : 'bg-violet-200',
    bgLight:        isDarkMode ? 'bg-violet-800' : 'bg-violet-100',
    bgCard:         isDarkMode ? 'bg-violet-800' : 'bg-violet-100',
    bgCardAlt:      isDarkMode ? 'bg-violet-800' : 'bg-violet-100',
    border:         isDarkMode ? 'border-violet-600' : 'border-violet-300',
    borderLight:    isDarkMode ? 'border-violet-600' : 'border-violet-300',
    shadow:         isDarkMode ? 'shadow-[1px_1px_0_0_#7c3aed]' : 'shadow-[1px_1px_0_0_#6d28d9]',
    buttonActive:   isDarkMode ? 'bg-violet-800 text-violet-300 border border-violet-600 translate-x-[2px] translate-y-[2px] shadow-[inset_2px_2px_0_0_#7c3aed]' : 'bg-violet-100 text-violet-700 border border-violet-300 translate-x-[2px] translate-y-[2px] shadow-[inset_2px_2px_0_0_#6d28d9]',
    buttonInactive: isDarkMode ? 'bg-violet-800 text-violet-300 border border-violet-600 hover:bg-violet-700 shadow-[2px_2px_0_0_#7c3aed]' : 'bg-violet-100 text-violet-700 border border-violet-300 hover:bg-violet-200 shadow-[2px_2px_0_0_#6d28d9]',
    toggleBg:       isDarkMode ? 'bg-violet-800' : 'bg-violet-100',
    toggleActive:   isDarkMode ? 'bg-violet-500 text-black' : 'bg-violet-600 text-white',
    toggleInactive: isDarkMode ? 'text-violet-300 hover:bg-violet-700' : 'text-violet-700 hover:bg-violet-200',
    input:          isDarkMode ? 'border-violet-600 bg-violet-800' : 'border-violet-300 bg-violet-100',
  },
  green: {
