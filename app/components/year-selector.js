...
<div
ref={sidebarRef}
className={fixed ${positionStyles} top-20 h-[calc(100vh-6rem)] z-50 transition-all duration-300 ${ expanded ? 'w-16 sm:w-20' : 'w-8' } ${colors.sidebarBg} ${colors.sidebarBorder} border-l border-r backdrop-blur-sm rounded-lg overflow-hidden}
>
{/* Toggle button */}
<button
