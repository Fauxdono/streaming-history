        ...
        return (
          <div className={
            ...
            <div className="hidden sm:flex justify-between items-center mb-2">
                ...
                <div className={`flex items-center gap-4 ${colorMode === 'colorful' ? 'text-blue-700 dark:text-blue-300' : ''}`}>
                    ...
                    <button
                      ...
                      className={
                        colorMode === 'colorful'
                          ...
                          : `px-3 py-1 rounded text-sm font-medium transition-colors ${isDarkMode ? 'bg-black text-white border border-white hover:bg-gray-800' : 'bg-white text-black border border-black hover:bg-gray-100'}`
                      }
                    >
              ...
              {/* Mobile controls */}
              <div className={`block sm:hidden space-y-2 ${colorMode === 'colorful' ? 'text-blue-700 dark:text-blue-300' : ''}`}>
