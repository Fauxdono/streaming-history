...
// bare ▲/▼ glyph buttons (no button chrome) stepping ±10, clamped to [1, max].
// Colors come from the host page via inputClass/buttonClass (text color for
// the arrows) so every tab keeps its own accent; the key remounts the
// uncontrolled input so arrow changes show up.
