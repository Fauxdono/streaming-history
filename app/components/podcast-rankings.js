...
const PodcastRankings = ({
  ...
  const modeColors = isColorful ? {
    ...
    bgLight: isDarkMode ? 'bg-red-800' : 'bg-red-50',
    bgCard: isDarkMode ? 'bg-red-800' : 'bg-red-50',
    bgCardAlt: isDarkMode ? 'bg-red-800' : 'bg-red-50',
    ...
    buttonInactive: isDarkMode ? 'bg-red-800 text-red-300 border border-red-600 hover:bg-red-700' : 'bg-red-50 text-red-700 border border-red-300 hover:bg-red-100',
  } : {
