...
const UpdatesSection = ({ colorMode = 'minimal' }) => {
  ...
  const modeColors = isColorful ? {
    ...
    buttonActive: isDarkMode ? 'bg-fuchsia-600 text-white' : 'bg-fuchsia-500 text-white',
    buttonInactive: isDarkMode ? 'bg-fuchsia-800 text-fuchsia-300 border border-fuchsia-600 hover:bg-fuchsia-700' : 'bg-fuchsia-100 text-fuchsia-700 border border-fuchsia-300 hover:bg-fuchsia-200',
    ...
    submitActive: isDarkMode ? 'bg-fuchsia-600 text-white hover:bg-fuchsia-500' : 'bg-fuchsia-500 text-white hover:bg-fuchsia-600',
