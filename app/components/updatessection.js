...
const UpdatesSection = ({ colorMode = 'minimal' }) => {
  ...
  const modeColors = isColorful ? {
    heading: isDarkMode ? 'text-fuchsia-300' : 'text-fuchsia-700',
    text: isDarkMode ? 'text-fuchsia-400' : 'text-fuchsia-600',
    muted: isDarkMode ? 'text-fuchsia-500' : 'text-fuchsia-500',
    cardBg: isDarkMode ? 'bg-fuchsia-800 border-fuchsia-600 hover:border-fuchsia-500' : 'bg-fuchsia-100 border-fuchsia-300 hover:border-fuchsia-400',
    inputBg: isDarkMode ? 'bg-fuchsia-800 border-fuchsia-600 text-fuchsia-200 placeholder-fuchsia-500' : 'bg-fuchsia-50 border-fuchsia-300 text-fuchsia-800 placeholder-fuchsia-400',
    ...
    submitActive: isDarkMode ? 'bg-fuchsia-600 text-white hover:bg-fuchsia-500 shadow-[2px_2px_0_0_#c026d3]' : 'bg-fuchsia-500 text-white hover:bg-fuchsia-600 shadow-[2px_2px_0_0_#a21caf]',
    submitDisabled: isDarkMode ? 'bg-fuchsia-900 text-fuchsia-600 cursor-not-allowed' : 'bg-fuchsia-200 text-fuchsia-400 cursor-not-allowed',
    voteUpActive: isDarkMode ? 'bg-fuchsia-700 text-fuchsia-200' : 'bg-fuchsia-200 text-fuchsia-700',
    voteUpInactive: isDarkMode ? 'bg-fuchsia-800 text-fuchsia-400 hover:bg-fuchsia-700 hover:text-fuchsia-200' : 'bg-fuchsia-100 text-fuchsia-500 hover:bg-fuchsia-200 hover:text-fuchsia-700',
    voteDownActive: isDarkMode ? 'bg-red-900/40 text-red-400' : 'bg-red-100 text-red-600',
    voteDownInactive: isDarkMode ? 'bg-fuchsia-800 text-fuchsia-400 hover:bg-red-900/40 hover:text-red-400' : 'bg-fuchsia-100 text-fuchsia-500 hover:bg-red-100 hover:text-red-600',
    voteCount: isDarkMode ? 'bg-fuchsia-800' : 'bg-fuchsia-100',
    notesBox: isDarkMode ? 'bg-fuchsia-800/50 text-fuchsia-300' : 'bg-fuchsia-100/50 text-fuchsia-700',
    adminBtn: isDarkMode ? 'text-fuchsia-500 hover:text-fuchsia-300 hover:bg-fuchsia-800' : 'text-fuchsia-400 hover:text-fuchsia-600 hover:bg-fuchsia-100',
    confirmBtn: isDarkMode ? 'bg-fuchsia-700 text-fuchsia-200 hover:bg-fuchsia-600' : 'bg-fuchsia-100 text-fuchsia-700 hover:bg-fuchsia-200',
    ...
    cancelBtn: isDarkMode ? 'text-fuchsia-500 hover:text-fuchsia-300' : 'text-fuchsia-400 hover:text-fuchsia-700',
    plannedBadge: isDarkMode ? 'bg-green-900/40 text-green-300' : 'bg-green-100 text-green-800',
    completedBadge: isDarkMode ? 'bg-fuchsia-800 text-fuchsia-300' : 'bg-fuchsia-100 text-fuchsia-800',
  } : {
    heading: isDarkMode ? 'text-[#FDF6E3]' : 'text-black',
    ...
    inputBg: isDarkMode ? 'bg-black border-[#4169E1] text-[#FDF6E3] placeholder-gray-500' : 'bg-white border-black text-black placeholder-gray-400',
    tabActive: isDarkMode ? 'text-[#FDF6E3] border-b-2 border-[#4169E1]' : 'text-black border-b-2 border-black',
    ...
    sortInactive: isDarkMode ? 'bg-black text-[#FDF6E3] border-r border-[#4169E1] hover:bg-gray-900' : 'bg-white text-black border-r border-black hover:bg-gray-100',
    submitActive: isDarkMode ? 'bg-black text-[#FDF6E3] border border-[#4169E1] hover:bg-gray-900 shadow-[2px_2px_0_0_#4169E1]' : 'bg-white text-black border border-black hover:bg-gray-100 shadow-[2px_2px_0_0_black]',
    ...
    notesBox: isDarkMode ? 'bg-black border border-[#4169E1] text-[#FDF6E3]' : 'bg-white border border-black text-black',
    adminBtn: isDarkMode ? 'text-gray-500 hover:text-white hover:bg-gray-900' : 'text-gray-400 hover:text-black hover:bg-gray-100',
    confirmBtn: isDarkMode ? 'bg-black text-[#FDF6E3] border border-[#4169E1] hover:bg-gray-900' : 'bg-white text-black border border-black hover:bg-gray-100',
    promoteConfirmBtn: isDarkMode ? 'bg-black text-[#FDF6E3] border border-[#4169E1] hover:bg-gray-900' : 'bg-white text-black border border-black hover:bg-gray-100',
    cancelBtn: isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-500 hover:text-black',
    plannedBadge: isDarkMode ? 'border border-[#4169E1] text-[#FDF6E3]' : 'border border-black text-black',
    completedBadge: isDarkMode ? 'border border-[#4169E1] text-[#FDF6E3]' : 'border border-black text-black',
  };
